...
// Appwrite imports
import { useAuthState, useSignOut } from "@/app/lib/appwrite/useAuth";
          ...
          >
            <span id={styles.img_container}>
              <Image
                ...
                alt={user ? (user.name || "User") : anilistUser?.name || "User"}
                fill
                sizes="32px"
              />
            </span>
            <span>{!isUserMenuOpen ? <ChevronDownSvg /> : <ChevronUpSvg />}</span>
          </button>
